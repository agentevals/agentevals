...
- **URL:** `https://agentevals.dev/schema/eval.schema.json`
...
{
  "yaml.schemas": {
    "https://agentevals.dev/schema/eval.schema.json": ["**/EVAL.yaml", "**/dataset.yaml"]
  }
}
```
...
- **CDN:** `https://agentevals.dev/schema/eval.schema.json`

```json
{
  "$schema": "https://json-schema.org/draft-07/schema#",
  "$id": "https://agentevals.dev/schema/eval.schema.json",
